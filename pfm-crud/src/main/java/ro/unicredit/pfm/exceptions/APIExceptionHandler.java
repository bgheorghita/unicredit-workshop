...
public class APIExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNotFoundException(RuntimeException ex, WebRequest request) {
        ...
        return handleExceptionInternal(ex, ex.getMessage() == null ? DefaultExceptionMessages.NOT_FOUND
    ...
    protected ResponseEntity<Object> handleUnexpectedException(RuntimeException ex, WebRequest request) {
        LOGGER_API_EXCEPTION.warn(ex.getMessage());
        return handleExceptionInternal(ex, DefaultExceptionMessages.UNEXPECTED_ERROR, new HttpHeaders(), HttpStatus.INTERNAL_SERVER_ERROR, request);
    }
}
